...
This internal analytics portal leverages machine learnig to
  ...
  #invoice flag
    ...
    **objective:**
    ...
    with st.form("invoice_flag_form"):
        ...
        submit_flag = st.form_submit_button(" 🧠 Evaluate Invoice_Risk")
    if submit_flag:
        input_data = {
        ...
        diff = abs(total_item_dollars - invoice_dollars)
